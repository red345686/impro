...
export default function ProcessingOptions({
    ...
    return (
        <div className="space-y-6 p-8 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md rounded-2xl shadow-xl border border-zinc-200/50 dark:border-zinc-800/50 card-hover">
            <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-purple-600 dark:from-blue-400 dark:to-purple-500 rounded-xl flex items-center justify-center text-xl shadow-lg">
                    ⚙️
                </div>
                <h3 className="text-2xl font-bold bg-linear-to-r from-zinc-900 to-zinc-600 dark:from-zinc-100 dark:to-zinc-400 bg-clip-text text-transparent">
                    Processing Settings
                </h3>
            </div>
            ...
            <div className="space-y-3">
                ...
                <select
                    ...
                    className="w-full px-4 py-3.5 bg-zinc-50 dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none transition-all duration-300 font-medium hover:border-zinc-300 dark:hover:border-zinc-600 cursor-pointer"
                >
            ...
            <div className="p-6 bg-linear-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 rounded-xl border-2 border-blue-200/50 dark:border-blue-800/50 shadow-md space-y-4">
                <div className="flex justify-between items-center">
                    <label className="flex items-center gap-2.5 text-base font-bold text-blue-900 dark:text-blue-100">
                        <span className="w-8 h-8 bg-linear-to-br from-blue-500 to-purple-600 dark:from-blue-400 dark:to-purple-500 rounded-lg flex items-center justify-center text-lg shadow-md">
                            🎨
                        </span>
                        <span>Quality</span>
                    </label>
                    <div className="flex items-center gap-3">
                        <span className="text-4xl font-extrabold bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent filter drop-shadow-sm">
                            {quality}%
                        </span>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <div className="relative pt-1">
                        ...
                        <div className="relative h-6 bg-white/80 dark:bg-zinc-800/80 rounded-full overflow-hidden shadow-inner backdrop-blur-sm border-2 border-blue-200/50 dark:border-blue-800/50">
                            ...
                            <div
                                ...
                                style={{ left: `calc(${quality}% - 14px)` }}
                            >
                                <div className="w-7 h-7 bg-white dark:bg-zinc-100 rounded-full shadow-lg border-3 border-blue-600 dark:border-blue-400 relative">
            ...
            <div className="border-t-2 border-zinc-200 dark:border-zinc-800 pt-6">
                <h4 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-5 flex items-center gap-2.5">
                    <span className="w-8 h-8 bg-linear-to-br from-purple-500 to-pink-600 dark:from-purple-400 dark:to-pink-500 rounded-lg flex items-center justify-center text-lg shadow-md">
                        ✨
                    </span>
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-3">
                        ...
                        <select
                            ...
                            className="w-full px-4 py-3.5 bg-zinc-50 dark:bg-zinc-800 border-2 border-zinc-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-purple-500 dark:focus:border-purple-400 focus:outline-none transition-all duration-300 text-sm font-medium hover:border-zinc-300 dark:hover:border-zinc-600 cursor-pointer"
                        >
                    ...
                    {/* Polish Toggle */}
                    <div className="p-5 bg-linear-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 rounded-xl border-2 border-purple-200/50 dark:border-purple-800/50 shadow-sm hover:shadow-md transition-all duration-300">
                        <label className="flex items-start gap-3.5 cursor-pointer group">
                            <input
                                type="checkbox"
                                checked={enablePolish}
                                onChange={(e) => onPolishChange(e.target.checked)}
                                className="mt-1 w-6 h-6 text-purple-600 dark:text-purple-400 bg-white dark:bg-zinc-700 border-2 border-purple-300 dark:border-purple-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 cursor-pointer transition-all duration-300"
                            />
                            <div className="flex-1">
                                <span className="text-sm font-bold text-purple-900 dark:text-purple-100 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors flex items-center gap-2">
                                    <span className="text-lg">💎</span>
